...
import {mostramensagem} from './mensagensReduce'
...
export function salvar(tarefa){
    return dispatch=>{
        http.post('/tarefas',tarefa,{
            ...
            },mostramensagem('Tarefa salva com sucesso!')])
        })
    }
}
    ...
    return dispatch=>{
        http.delete(`/tarefas/${id}`,{
            ...
            dispatch([{
                ...
                id:id
            },mostramensagem('Tarefa deletada com sucesso!')])
        })
    }
}
...
export function alterarStatus(id){
    return dispatch =>{
        ...
        dispatch([{
            ...
            id:id
        },mostramensagem('Tarefa atualizada com sucesso!')])
    })
    }
}